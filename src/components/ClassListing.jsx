...
const ClassListing = ({workout}) => {
  ...
  let description = workout.data.description;
...
// show short version of description
  ...
  return (
    ...
    <div className="p-4">
      <div className="mb-6">
        <div className="text-gray-600 my-2">{workout.data.type}</div>
        <h3 className="text-xl font-bold">{workout.data.title}</h3>
      </div>
      ...
      { workout.data.type === "Session" ? 
          <h3 className="text-navy mb-2">${workout.data.cost} CAD per 10 sessions</h3>
       : 
          <h3 className="text-navy mb-2">${workout.data.cost} CAD</h3> 
      }
